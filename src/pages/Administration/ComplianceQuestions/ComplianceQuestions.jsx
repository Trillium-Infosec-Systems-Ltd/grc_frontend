...
function ComplianceQuestions() {
  return (
    <Routes>
      ...
      <Route
        path={COMPLIANCE_QUESTIONS.CREATE}
        element={<ComplianceQuestionForm MODE={KEY.VIEW} />}
      />
      <Route
        path={COMPLIANCE_QUESTIONS.EDIT}
        element={<ComplianceQuestionForm MODE={KEY.EDIT} />}
      />
    </Routes>
  );
}
